...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.22\textwidth}
        \centering
        \includegraphics[width=1\columnwidth]{figures/exp2/bertviz/yrp1/bert_model_view_ypr1_layer_11_head_1.png}
        \caption{Broad.}
        \label{}
     \end{subfigure}
    %  \hfill
     ...
     \begin{subfigure}[b]{0.22\textwidth}
        \centering
        \includegraphics[width=1\columnwidth]{figures/exp2/bertviz/yrp1/bert_model_view_ypr1_layer_2_head_9.png}
        \caption{Next.}
        \label{}
     \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.22\textwidth}
        \centering
        \includegraphics[width=1\columnwidth]{figures/exp2/bertviz/yrp1/bert_model_view_ypr1_layer_4_head_4.png}
        \caption{Special.}
        \label{}
     \end{subfigure}
    %  \hfill
    \quad
     \begin{subfigure}[b]{0.22\textwidth}
        \centering
        \includegraphics[width=1\columnwidth]{figures/exp2/bertviz/yrp1/bert_model_view_ypr1_layer_9_head_0.png}
        \caption{Age.}
        \label{}
     \end{subfigure}
    \caption{}
