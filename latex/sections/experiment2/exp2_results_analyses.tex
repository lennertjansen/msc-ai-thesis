...
% \begin{itemize}
%     \item I use BertViz \citep{vig-2019-multiscale} to visualize and study the attention mechanism maps of BERT$_{FT}$.
...
%     \item I refer to an attention head as Head \texttt{layer}-\texttt{head}, where \texttt{layer} and \texttt{head} range from 0 to 11: e.g., Head 3-1 refers to Layer 3, Head 1.
