...
\len{\textbf{TODO} - Make a Table with interesting examples}

Table \len{MAKE TABLE} shows examples of generated responses containing the patterns and observations discussed in the remainder of this section.
