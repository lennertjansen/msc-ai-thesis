...
As can be seen, a quite large fraction of samples is correctly classified by both models (63.17\%), while in 19.78\% of cases neither of the models make a correct prediction. The remaining cases are comparably split between cases where only one of the two is correct, with BERT slightly outperforming the trigram model by 1.23 percentage points. %, but the other is not.
