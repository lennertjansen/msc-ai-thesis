...
\begin{table*}[h]
    ...
    bigram & 0.625 (0.001) & 0.790 (0.001) & 0.712 (0.001) & \textcolor{blue}{0.518} (0.001)\\
    trigram & 0.623 (0.001) & \textcolor{blue}{0.790} (0.001) & 0.712 (0.002) & 0.498 (0.002)\\
    \midrule
    LSTM & 0.663 (0.005) & 0.748 (0.003) & 0.664 (0.010) & 0.502 (0.004) \\
...
\begin{table*}[h]
    ...
    G-B$_{O, FB}$ & 28.81 ($\pm$10.10) & 0.86 ($\pm$0.10) & 0.93 ($\pm$0.05) & 0.90 ($\pm$0.06) & 0.59 ($\pm$0.43) & 41 & 41.1\%\\
    ...
    G-D$_{O}$ & 95.21 ($\pm$174.42) & 0.65 ($\pm$0.27) & 0.78 ($\pm$0.18) & 0.78 ($\pm$0.18) & 0.90 ($\pm$0.25) & 0.10 & 90.3\%\\
    \midrule
    \midrule
