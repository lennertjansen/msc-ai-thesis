...
#SBATCH --job-name=ctg_young_prompt_unpert_baseline_discrim_young_and_old
...
#SBATCH -o /home/lennertj/code/msc-ai-thesis/SLURM/output/ctg_explore/ctg_young_prompt_unpert_baseline_discrim_young_and_old.%A.out ## this is where the terminal output is printed to. %j is root job number, %a array number. try %j_%a ipv %A (job id)
