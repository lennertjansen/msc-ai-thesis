...
#SBATCH --job-name=ctg_explore_bow_based_30_per_config
...
#SBATCH -o /home/lennertj/code/msc-ai-thesis/SLURM/output/ctg_explore/ctg_explore_bow_based_30_per_config.%A.out ## this is where the terminal output is printed to. %j is root job number, %a array number. try %j_%a ipv %A (job id)
