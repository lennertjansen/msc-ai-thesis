...
#SBATCH --job-name=real_deal_bnc_trigram_bert_case_analysis_tryout
...
#SBATCH -o /home/lennertj/code/msc-ai-thesis/SLURM/output/real_deal_bnc_trigram_bert_case_analysis_tryout.%A.out ## this is where the terminal output is printed to. %j is root job number, %a array number. try %j_%a ipv %A (job id)
