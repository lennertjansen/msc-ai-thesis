...
#SBATCH --job-name=classif_blog_ws_bert_ft_2seeds_ACTUALLY_BLOGS_EVEN_more_seeds
...
#SBATCH -o /home/lennertj/code/msc-ai-thesis/SLURM/output/classif_blog_ws_bert_ft_2seeds_ACTUALLY_BLOGS_EVEN_more_seeds.%A.out ## this is where the terminal output is printed to. %j is root job number, %a array number. try %j_%a ipv %A (job id)
