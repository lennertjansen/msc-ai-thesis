...
#SBATCH --job-name=classif_BLOGS_ws_best_LSTM_lr_1emin4_emb_256_hid_512_nl_1_Correction_trainmode
...
#SBATCH -o /home/lennertj/code/msc-ai-thesis/SLURM/output/classif_BLOGS_ws_best_LSTM_lr_1emin4_emb_256_hid_512_nl_1_Correction_trainmode.%A.out ## this is where the terminal output is printed to. %j is root job number, %a array number. try %j_%a ipv %A (job id)
