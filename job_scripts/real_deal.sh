...
#SBATCH --job-name=real_deal_bnc_ws_bert_frozen_pplm_alt_seeds
...
#SBATCH -o /home/lennertj/code/msc-ai-thesis/SLURM/output/real_deal_bnc_ws_bert_frozen_pplm_alt_seeds.%A.out ## this is where the terminal output is printed to. %j is root job number, %a array number. try %j_%a ipv %A (job id)
