...
#SBATCH --job-name=ctg_train_discrim_bert
...
#SBATCH -o /home/lennertj/code/msc-ai-thesis/SLURM/output/ctg_train_discrim_bert.%A.out ## this is where the terminal output is printed to. %j is root job number, %a array number. try %j_%a ipv %A (job id)
