...
#SBATCH --job-name=ctg_young_discrim_gpt2_sl512_incl_sw_nac
...
#SBATCH -o /home/lennertj/code/msc-ai-thesis/SLURM/output/ctg_young_discrim_gpt2_sl512_incl_sw_nac.%A.out ## this is where the terminal output is printed to. %j is root job number, %a array number. try %j_%a ipv %A (job id)
