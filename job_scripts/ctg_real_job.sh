...
#SBATCH --job-name=ctg_discrim_gp2_med_ml512_lr_00001_WS_quick_sandro_old
...
#SBATCH -o /home/lennertj/code/msc-ai-thesis/SLURM/output/ctg_discrim_gp2_med_ml512_lr_00001_WS_quick_sandro_old.%A.out ## this is where the terminal output is printed to. %j is root job number, %a array number. try %j_%a ipv %A (job id)
