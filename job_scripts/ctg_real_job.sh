...
#SBATCH --job-name=ctg_bow_young_fb_pct_85_ws
...
#SBATCH -o /home/lennertj/code/msc-ai-thesis/SLURM/output/ctg_bow_young_fb_pct_85_ws.%A.out ## this is where the terminal output is printed to. %j is root job number, %a array number. try %j_%a ipv %A (job id)
