...
#SBATCH --job-name=ctg_gpt2_baseline_50_50_redo_old
...
#SBATCH -o /home/lennertj/code/msc-ai-thesis/SLURM/output/ctg_gpt2_baseline_50_50_redo_old.%A.out ## this is where the terminal output is printed to. %j is root job number, %a array number. try %j_%a ipv %A (job id)
