...
#SBATCH --job-name=ctg_old_bow_100miu
...
#SBATCH -o /home/lennertj/code/msc-ai-thesis/SLURM/output/ctg_old_bow_100miu.%A.out ## this is where the terminal output is printed to. %j is root job number, %a array number. try %j_%a ipv %A (job id)
