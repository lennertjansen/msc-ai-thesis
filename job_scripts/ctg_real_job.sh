...
#SBATCH --job-name=scripted_dialogue_generation_hobby_turnwise_young
...
#SBATCH -o /home/lennertj/code/msc-ai-thesis/SLURM/output/scripted_dialogue_generation_hobby_turnwise_young.%A.out ## this is where the terminal output is printed to. %j is root job number, %a array number. try %j_%a ipv %A (job id)
